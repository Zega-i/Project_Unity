...
import {
  ...
  SafeAreaView, ActivityIndicator, Image, KeyboardAvoidingView,
...
const styles = StyleSheet.create({
  ...
  modalCloseBtn: { backgroundColor: '#1E293B', borderRadius: 14, paddingVertical: 14, paddingHorizontal: 40, width: '100%', alignItems: 'center' },
